<template>
  <div class="WebBtn">
    <div class="fotter" v-show="showBottom">
      ...
      <div class="fotter-copy">
        <div class="copy-select">
          ...
          <a href="javascript:;" @click="ShowDialog">联系我们</a>
          <span class="mod_copy">|</span>
          <a href="">联系客服</a>
          <span class="mod_copy">|</span>
          <a href="">系统中心</a>
    ...
    <webAboutContact ref="webAboutContact"></webAboutContact>
  </div>
</template>

<script>
import webAboutContact from "./webAboutContact.vue";
export default {
  name: "webFotter",
  data(){
    return{
  ...
  methods:{
    ShowDialog(){
      ...
      this.$refs.webAboutContact.Dialog(this.showBottom);
    }
  }
};
</script>
