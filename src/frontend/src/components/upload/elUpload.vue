        ...
        uploadQuestionPicture({fileName,location})
          .then(res => {
            ...
            if(this.$parent.prop === 'answerImage'){
              ...
              this.$parent.$parent.$parent.ruleForm.answerImage = res.data.data.key
            }else if(this.$parent.prop === 'enclosureImage'){
              this.$parent.$parent.$parent.ruleForm.enclosureImage = res.data.data.key
            }else if(this.$parent.prop === 'solutionImage'){
              this.$parent.$parent.$parent.ruleForm.solutionImage = res.data.data.key
            }else if(this.$parent.prop === 'titleImage'){
              this.$parent.$parent.$parent.ruleForm.titleImage = res.data.data.key
            }else{
