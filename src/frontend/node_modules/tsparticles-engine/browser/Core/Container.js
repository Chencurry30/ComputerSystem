...
export class Container {
    ...
    constructor(engine, id, sourceOptions) {
        ...
        this._engine.dispatchEvent("containerBuilt" /* EventType.containerBuilt */, { container: this });
    }
    /**
    ...
    destroy() {
        ...
        this._engine.dispatchEvent("containerDestroyed" /* EventType.containerDestroyed */, { container: this });
    }
    /**
     * Draws a frame
     */
    ...
    async init() {
        ...
        this._engine.dispatchEvent("containerInit" /* EventType.containerInit */, { container: this });
        this.particles.init();
        ...
        this._engine.dispatchEvent("particlesSetup" /* EventType.particlesSetup */, { container: this });
    }
    /**
    ...
    pause() {
        ...
        this._engine.dispatchEvent("containerPaused" /* EventType.containerPaused */, { container: this });
    }
    /**
    ...
    play(force) {
        ...
        this._engine.dispatchEvent("containerPlay" /* EventType.containerPlay */, { container: this });
    ...
    async start() {
        ...
        this._engine.dispatchEvent("containerStarted" /* EventType.containerStarted */, { container: this });
        this.play();
    }
    /**
    ...
    stop() {
        ...
        this._engine.dispatchEvent("containerStopped" /* EventType.containerStopped */, { container: this });
    }
    /**
