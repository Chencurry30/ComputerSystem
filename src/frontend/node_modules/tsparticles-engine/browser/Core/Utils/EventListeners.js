...
export class EventListeners {
    ...
    manageListeners(add) {
        ...
        if (detectType === "window" /* InteractivityDetect.window */) {
            container.interactivity.element = window;
            mouseLeaveTmpEvent = mouseOutEvent;
        }
        else if (detectType === "parent" /* InteractivityDetect.parent */ && container.canvas.element) {
    ...
    mouseTouchMove(e) {
        ...
        if (e.type.startsWith("pointer")) {
            ...
            else if (options.interactivity.detectsOn === "parent" /* InteractivityDetect.parent */) {
