...
export function areBoundsInside(bounds, size, offset, direction) {
    let inside = true;
    if (!direction || direction === "bottom" /* OutModeDirection.bottom */) {
        inside = bounds.top < size.height + offset.x;
    }
    if (inside && (!direction || direction === "left" /* OutModeDirection.left */)) {
        inside = bounds.right > offset.x;
    }
    if (inside && (!direction || direction === "right" /* OutModeDirection.right */)) {
        inside = bounds.left < size.width + offset.y;
    }
    if (inside && (!direction || direction === "top" /* OutModeDirection.top */)) {
