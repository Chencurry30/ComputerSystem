(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../Utils/NumberUtils", "./Utils/InteractionManager", "./Particle", "./Utils/Point", "./Utils/QuadTree", "./Utils/Rectangle"], factory);
    }
    ...
    class Particles {
        ...
        _pushParticle(position, overrideOptions, group, initializer) {
            try {
                const particle = new Particle_1.Particle(this._engine, this.nextId, this.container, position, overrideOptions, group);
                let canAdd = true;
                if (initializer) {
