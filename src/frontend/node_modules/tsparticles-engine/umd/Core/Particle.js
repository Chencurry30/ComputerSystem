(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../Utils/NumberUtils", "../Utils/Utils", "../Utils/ColorUtils", "../Options/Classes/Interactivity/Interactivity", "../Options/Classes/Particles/Shape/Shape", "./Utils/Vector", "./Utils/Vector3d", "../Utils/CanvasUtils", "../Utils/OptionsUtils"], factory);
    }
    ...
    class Particle {
        constructor(engine, id, container, position, overrideOptions, group) {
            ...
            const pxRatio = container.retina.pixelRatio, mainOptions = container.actualOptions, particlesOptions = (0, OptionsUtils_1.loadParticlesOptions)(this._engine, container, mainOptions.particles), shapeType = particlesOptions.shape.type, reduceDuplicates = particlesOptions.reduceDuplicates;
            this.shape = (0, Utils_1.itemFromSingleOrMultiple)(shapeType, this.id, reduceDuplicates);
            if (overrideOptions === null || overrideOptions === void 0 ? void 0 : overrideOptions.shape) {
                if (overrideOptions.shape.type) {
                    const overrideShapeType = overrideOptions.shape.type;
                    this.shape = (0, Utils_1.itemFromSingleOrMultiple)(overrideShapeType, this.id, reduceDuplicates);
                }
            ...
            if (sizeAnimation.enable) {
                ...
                switch (sizeAnimation.startValue) {
                    ...
                    case "random":
                        ...
                        this.size.status = (0, NumberUtils_1.getRandom)() >= 0.5 ? 0 : 1;
                        break;
                    case "max":
                    default:
                ...
                if (!sizeAnimation.sync) {
                    this.size.velocity *= (0, NumberUtils_1.getRandom)();
                }
            }
            this.bubble = {
                inRange: false,
