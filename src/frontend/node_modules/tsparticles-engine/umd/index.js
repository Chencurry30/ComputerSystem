...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./engine", "./Utils/HslColorManager", "./Utils/RgbColorManager", "./Utils/ColorUtils", "./Core/Interfaces/Colors", "./Core/Interfaces/IBounds", "./Core/Interfaces/IBubbleParticleData", "./Core/Interfaces/ICircleBouncer", "./Core/Interfaces/IColorManager", "./Core/Interfaces/IContainerInteractivity", "./Core/Interfaces/IContainerPlugin", "./Core/Interfaces/ICoordinates", "./Core/Interfaces/IDelta", "./Core/Interfaces/IDimension", "./Core/Interfaces/IDistance", "./Core/Interfaces/IExternalInteractor", "./Core/Interfaces/IInteractor", "./Core/Interfaces/IMouseData", "./Core/Interfaces/IMovePathGenerator", "./Core/Interfaces/IParticle", "./Core/Interfaces/IParticleColorStyle", "./Core/Interfaces/IParticleHslAnimation", "./Core/Interfaces/IParticlesInteractor", "./Core/Interfaces/IParticleLife", "./Core/Interfaces/IParticleRetinaProps", "./Core/Interfaces/IParticleRoll", "./Core/Interfaces/IParticleTransformValues", "./Core/Interfaces/IParticleUpdater", "./Core/Interfaces/IParticleValueAnimation", "./Core/Interfaces/IParticleWobble", "./Core/Interfaces/IParticlesMover", "./Core/Interfaces/IPlugin", "./Core/Interfaces/IRangeValue", "./Core/Interfaces/IRectSideResult", "./Core/Interfaces/IShapeDrawer", "./Core/Interfaces/IShapeValues", "./Core/Interfaces/ISlowParticleData", "./Core/Utils/Circle", "./Core/Utils/Constants", "./Core/Utils/ExternalInteractorBase", "./Core/Utils/ParticlesInteractorBase", "./Core/Utils/Point", "./Core/Utils/Range", "./Core/Utils/Rectangle", "./Core/Utils/Vector", "./Core/Utils/Vector3d", "./Enums/Directions/MoveDirection", "./Enums/Directions/RotateDirection", "./Enums/Directions/OutModeDirection", "./Enums/Modes/ClickMode", "./Enums/Modes/DivMode", "./Enums/Modes/HoverMode", "./Enums/Modes/CollisionMode", "./Enums/Modes/OutMode", "./Enums/Modes/SizeMode", "./Enums/Modes/ThemeMode", "./Enums/Modes/ResponsiveMode", "./Enums/Types/AlterType", "./Enums/Types/DestroyType", "./Enums/Types/GradientType", "./Enums/Types/InteractorType", "./Enums/Types/ParticleOutType", "./Enums/Types/StartValueType", "./Enums/Types/DivType", "./Enums/Types/EasingType", "./Enums/AnimationStatus", "./Enums/InteractivityDetect", "./Options/Classes/AnimatableColor", "./Options/Classes/AnimationOptions", "./Options/Classes/Background/Background", "./Options/Classes/BackgroundMask/BackgroundMask", "./Options/Classes/BackgroundMask/BackgroundMaskCover", "./Options/Classes/ColorAnimation", "./Options/Classes/FullScreen/FullScreen", "./Options/Classes/HslAnimation", "./Options/Classes/Interactivity/Events/ClickEvent", "./Options/Classes/Interactivity/Events/DivEvent", "./Options/Classes/Interactivity/Events/ClickEvent", "./Options/Classes/Interactivity/Events/DivEvent", "./Options/Classes/Interactivity/Events/Events", "./Options/Classes/Interactivity/Events/HoverEvent", "./Options/Classes/Interactivity/Events/Parallax", "./Options/Classes/Interactivity/Interactivity", "./Options/Classes/Interactivity/Modes/Modes", "./Options/Classes/ManualParticle", "./Options/Classes/Motion/Motion", "./Options/Classes/Motion/MotionReduce", "./Options/Classes/Options", "./Options/Classes/OptionsColor", "./Options/Classes/Particles/Bounce/ParticlesBounce", "./Options/Classes/Particles/Bounce/ParticlesBounceFactor", "./Options/Classes/Particles/Collisions/Collisions", "./Options/Classes/Particles/Collisions/CollisionsOverlap", "./Options/Classes/Particles/ParticlesOptions", "./Options/Classes/Particles/Shadow", "./Options/Classes/Particles/Stroke", "./Options/Classes/Particles/Move/MoveAttract", "./Options/Classes/Particles/Move/Move", "./Options/Classes/Particles/Move/MoveAngle", "./Options/Classes/Particles/Move/MoveGravity", "./Options/Classes/Particles/Move/OutModes", "./Options/Classes/Particles/Move/Path/MovePath", "./Options/Classes/Particles/Move/Path/MovePathDelay", "./Options/Classes/Particles/Move/Spin", "./Options/Classes/Particles/Move/MoveTrail", "./Options/Classes/Particles/Number/ParticlesNumber", "./Options/Classes/Particles/Number/ParticlesDensity", "./Options/Classes/Particles/Opacity/Opacity", "./Options/Classes/Particles/Opacity/OpacityAnimation", "./Options/Classes/Particles/Rotate/Rotate", "./Options/Classes/Particles/Rotate/RotateAnimation", "./Options/Classes/Particles/Shape/Shape", "./Options/Classes/Particles/Size/Size", "./Options/Classes/Particles/Size/SizeAnimation", "./Options/Classes/Particles/ZIndex/ZIndex", "./Options/Classes/Responsive", "./Options/Classes/Theme/Theme", "./Options/Classes/Theme/ThemeDefault", "./Options/Classes/ValueWithRandom", "./Options/Interfaces/Background/IBackground", "./Options/Interfaces/BackgroundMask/IBackgroundMask", "./Options/Interfaces/BackgroundMask/IBackgroundMaskCover", "./Options/Interfaces/FullScreen/IFullScreen", "./Options/Interfaces/IAnimatable", "./Options/Interfaces/IAnimatableColor", "./Options/Interfaces/IAnimation", "./Options/Interfaces/IColorAnimation", "./Options/Interfaces/IHslAnimation", "./Options/Interfaces/IManualParticle", "./Options/Interfaces/IOptionLoader", "./Options/Interfaces/IOptions", "./Options/Interfaces/IOptionsColor", "./Options/Interfaces/IResponsive", "./Options/Interfaces/IValueWithRandom", "./Options/Interfaces/Interactivity/Events/IClickEvent", "./Options/Interfaces/Interactivity/Events/IDivEvent", "./Options/Interfaces/Interactivity/Events/IEvents", "./Options/Interfaces/Interactivity/Events/IHoverEvent", "./Options/Interfaces/Interactivity/Events/IParallax", "./Options/Interfaces/Interactivity/Modes/IModeDiv", "./Options/Interfaces/Interactivity/Modes/IModes", "./Options/Interfaces/Interactivity/IInteractivity", "./Options/Interfaces/Motion/IMotion", "./Options/Interfaces/Motion/IMotionReduce", "./Options/Interfaces/Particles/Bounce/IParticlesBounce", "./Options/Interfaces/Particles/Collisions/ICollisions", "./Options/Interfaces/Particles/Collisions/ICollisionsOverlap", "./Options/Interfaces/Particles/IParticlesOptions", "./Options/Interfaces/Particles/IShadow", "./Options/Interfaces/Particles/IStroke", "./Options/Interfaces/Particles/Move/IMoveAttract", "./Options/Interfaces/Particles/Move/IMove", "./Options/Interfaces/Particles/Move/IMoveAngle", "./Options/Interfaces/Particles/Move/IMoveGravity", "./Options/Interfaces/Particles/Move/Path/IMovePath", "./Options/Interfaces/Particles/Move/IOutModes", "./Options/Interfaces/Particles/Move/ISpin", "./Options/Interfaces/Particles/Move/IMoveTrail", "./Options/Interfaces/Particles/Number/IParticlesDensity", "./Options/Interfaces/Particles/Number/IParticlesNumber", "./Options/Interfaces/Particles/Opacity/IOpacity", "./Options/Interfaces/Particles/Opacity/IOpacityAnimation", "./Options/Interfaces/Particles/Rotate/IRotate", "./Options/Interfaces/Particles/Rotate/IRotateAnimation", "./Options/Interfaces/Particles/Shape/ICharacterShape", "./Options/Interfaces/Particles/Shape/IImageShape", "./Options/Interfaces/Particles/Shape/IPolygonShape", "./Options/Interfaces/Particles/Shape/IShape", "./Options/Interfaces/Particles/Shape/IShapeValues", "./Options/Interfaces/Particles/Shape/IStarShape", "./Options/Interfaces/Particles/Size/ISize", "./Options/Interfaces/Particles/Size/ISizeAnimation", "./Options/Interfaces/Particles/ZIndex/IZIndex", "./Options/Interfaces/Theme/ITheme", "./Options/Interfaces/Theme/IThemeDefault", "./Types/RangeValue", "./Types/RecursivePartial", "./Types/ShapeData", "./Types/ShapeDrawerFunctions", "./Types/SingleOrMultiple", "./Types/PathOptions", "./Utils/CanvasUtils", "./Utils/ColorUtils", "./Utils/HslColorManager", "./Utils/NumberUtils", "./Utils/OptionsUtils", "./Utils/RgbColorManager", "./Utils/Utils"], factory);
    }
    ...
    (0, ColorUtils_1.addColorManager)("rgb", rgbColorManager);
    (0, ColorUtils_1.addColorManager)("hsl", hslColorManager);
