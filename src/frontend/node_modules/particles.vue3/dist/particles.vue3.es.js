import { defineComponent as We, nextTick as qe, openBlock as Be, createElementBlock as Ue } from "vue";
class $e {
  constructor() {
...
function Ze(n) {
  var e, t, i, s;
  return {
    x: (t = (e = n.position) === null || e === void 0 ? void 0 : e.x) !== null && t !== void 0 ? t : I() * n.size.width,
    y: (s = (i = n.position) === null || i === void 0 ? void 0 : i.y) !== null && s !== void 0 ? s : I() * n.size.height
  };
}
function Ce(n) {
...
function Qe() {
  return j() ? (n) => setTimeout(n) : (n) => (requestAnimationFrame || setTimeout)(n);
}
function Ke() {
  return j() ? (n) => clearTimeout(n) : (n) => (cancelAnimationFrame || clearTimeout)(n);
}
function pe(n, e) {
  return n === e || e instanceof Array && e.indexOf(n) > -1;
}
function et(n) {
  return Math.floor(I() * n.length);
}
function he(n, e, t = !0) {
  const i = e !== void 0 && t ? e % n.length : et(n);
  return n[i];
}
function M(n, ...e) {
  for (const t of e) {
...
const tt = "random", ie = /* @__PURE__ */ new Map();
function Oe(n, e) {
  ie.set(n, e);
}
function ne(n, e, t) {
...
function Se(n, e, t = !0) {
  ...
  const i = typeof n == "string" ? { value: n } : n;
  if (typeof i.value == "string")
    return i.value === tt ? rt() : nt(i.value);
  if (i.value instanceof Array)
    return Se({
      value: he(i.value, e, t)
    });
...
function ae(n) {
  ...
  if (!t.s)
    ...
    e.r = ne(s, i, t.h + 1 / 3), e.g = ne(s, i, t.h), e.b = ne(s, i, t.h - 1 / 3);
  }
...
function rt(n) {
  const e = n != null ? n : 0;
  return {
    b: Math.floor(W(y(e, 256))),
    g: Math.floor(W(y(e, 256))),
    r: Math.floor(W(y(e, 256)))
  };
}
function K(n, e) {
...
function lt(n) {
  ...
  const E = p.rotation + (p.options.rotate.path ? p.velocity.angle : 0);
  E !== 0 && h.rotate(E), v && (h.globalCompositeOperation = g);
  const L = p.shadowColor;
  P.enable && L && (h.shadowBlur = P.blur, h.shadowColor = K(L), h.shadowOffsetX = P.offset.x, h.shadowOffsetY = P.offset.y), m.fill && (h.fillStyle = m.fill);
  const A = p.stroke;
  h.lineWidth = (o = p.strokeWidth) !== null && o !== void 0 ? o : 0, m.stroke && (h.strokeStyle = m.stroke), ht(u, h, p, k, S, f), ((r = A == null ? void 0 : A.width) !== null && r !== void 0 ? r : 0) > 0 && h.stroke(), p.close && h.closePath(), p.fill && h.fill(), h.restore(), h.save(), w.a !== void 0 || w.b !== void 0 || w.c !== void 0 || w.d !== void 0 ? h.setTransform((a = w.a) !== null && a !== void 0 ? a : 1, (l = w.b) !== null && l !== void 0 ? l : 0, (c = w.c) !== null && c !== void 0 ? c : 0, (d = w.d) !== null && d !== void 0 ? d : 1, x.x, x.y) : h.translate(x.x, x.y), p.rotation && h.rotate(p.rotation), v && (h.globalCompositeOperation = g), ct(u, h, p, k, S, f), h.restore();
}
function ht(n, e, t, i, s, o) {
  if (!t.shape)
    return;
  const r = n.drawers.get(t.shape);
  !r || r.draw(e, t, i, s, o, n.retina.pixelRatio);
}
function ct(n, e, t, i, s, o) {
  if (!t.shape)
    return;
  const r = n.drawers.get(t.shape);
...
const Y = "generated", ye = "touchend", pt = "pointerdown", vt = "pointerup", be = "pointermove", mt = "touchstart", gt = "touchmove", _e = "pointerleave", yt = "pointerout", bt = "touchcancel", _t = "resize", wt = "visibilitychange";
function xt(n, e, t) {
  var i;
  const s = e[t];
...
class zt {
  ...
  clear() {
    ...
    e.backgroundMask.enable ? this.paint() : t.enable && t.length > 0 && this._trailFillColor ? this._paintBase(K(this._trailFillColor, 1 / t.length)) : this.draw((i) => {
      oe(i, this.size);
    });
  }
  destroy() {
  ...
  drawParticle(e, t) {
    ...
    a || (a = o), l || (l = r), !(!a && !l) && this.draw((c) => {
      var d, u, h, p, f;
      const m = this.container.actualOptions, v = e.options.zIndex, g = (1 - e.zIndexFactor) ** v.opacityRate, k = (h = (d = e.bubble.opacity) !== null && d !== void 0 ? d : (u = e.opacity) === null || u === void 0 ? void 0 : u.value) !== null && h !== void 0 ? h : 1, S = (f = (p = e.stroke) === null || p === void 0 ? void 0 : p.opacity) !== null && f !== void 0 ? f : k, P = k * g, w = S * g, x = {}, E = {
        fill: a ? me(a, P) : void 0
      };
      E.stroke = l ? me(l, w) : E.fill, this._applyPreDrawUpdaters(c, e, s, P, E, x), lt({
  ...
  initBackground() {
    ...
    if (!!s) {
      if (t.color) {
        const o = q(t.color);
        s.backgroundColor = o ? K(o, t.opacity) : "";
      } else
        s.backgroundColor = "";
  ...
  loadCanvas(e) {
    var t;
    this._generatedCanvas && ((t = this.element) === null || t === void 0 || t.remove()), this._generatedCanvas = e.dataset && Y in e.dataset ? e.dataset[Y] === "true" : this._generatedCanvas, this.element = e, this._originalStyle = M({}, this.element.style), this.size.height = e.offsetHeight, this.size.width = e.offsetWidth, this._context = this.element.getContext("2d"), this.container.retina.init(), this.initBackground();
  }
  paint() {
    const e = this.container.actualOptions;
    this.draw((t) => {
      e.backgroundMask.enable && e.backgroundMask.cover ? (oe(t, this.size), this._paintBase(this._coverColorStyle)) : this._paintBase();
    });
  }
  resize() {
    if (!this.element)
  ...
  _getPluginParticleColors(e) {
    ...
    for (const s of this._colorPlugins)
      if (!t && s.particleFillColor && (t = ve(s.particleFillColor(e))), !i && s.particleStrokeColor && (i = ve(s.particleStrokeColor(e))), t && i)
        break;
    return [t, i];
  }
  _initCover() {
    const e = this.container.actualOptions, t = e.backgroundMask.cover, i = t.color, s = q(i);
    if (s) {
      const o = {
        r: s.r,
        g: s.g,
  ...
  _initTrail() {
    const e = this.container.actualOptions, t = e.particles.move.trail, i = q(t.fillColor);
    if (i) {
...
class Mt {
  ...
  doMouseTouchClick(e) {
    ...
    if (this.canPush) {
      ...
      B(o.mode, (r) => this.handleClickMode(r));
    }
  ...
  manageListeners(e) {
    ...
    let r = _e;
    if (o === "window")
      i.interactivity.element = window, r = yt;
    ...
    const a = !j() && typeof matchMedia < "u" && matchMedia("(prefers-color-scheme: dark)");
    ...
    if (!l)
      return;
    const c = l;
    (s.interactivity.events.onHover.enable || s.interactivity.events.onClick.enable) && (O(l, be, this.mouseMoveHandler, e), O(l, mt, this.touchStartHandler, e), O(l, gt, this.touchMoveHandler, e), s.interactivity.events.onClick.enable ? (O(l, ye, this.touchEndClickHandler, e), O(l, vt, this.mouseUpHandler, e), O(l, pt, this.mouseDownHandler, e)) : O(l, ye, this.touchEndHandler, e), O(l, r, this.mouseLeaveHandler, e), O(l, bt, this.touchCancelHandler, e)), i.canvas.element && (i.canvas.element.style.pointerEvents = c === i.canvas.element ? "initial" : "none"), s.interactivity.events.resize && (typeof ResizeObserver < "u" ? this.resizeObserver && !e ? (i.canvas.element && this.resizeObserver.unobserve(i.canvas.element), this.resizeObserver.disconnect(), delete this.resizeObserver) : !this.resizeObserver && e && i.canvas.element && (this.resizeObserver = new ResizeObserver((d) => {
      !d.find((h) => h.target === i.canvas.element) || this.handleWindowResize();
    }), this.resizeObserver.observe(i.canvas.element)) : O(window, _t, this.resizeHandler, e)), document && O(document, wt, this.visibilityChangeHandler, e, !1);
  }
  mouseDown() {
  ...
  mouseTouchFinish() {
    ...
    if (!e)
      return;
    const t = e.mouse;
    delete t.position, delete t.clickPosition, delete t.downPosition, e.status = _e, t.inside = !1, t.clicking = !1;
  }
  mouseTouchMove(e) {
    var t, i, s, o, r, a, l;
    ...
    u && (u.x *= p, u.y *= p), c.interactivity.mouse.position = u, c.interactivity.status = be;
  }
}
function Pt(n, e = 60, t = !1) {
  return {
    value: n,
...
class kt {
  ...
  async nextFrame(e) {
    ...
    try {
      ...
      const s = Pt(e - i.lastFrameTime, i.fpsLimit, i.smooth);
...
class Ct {
  constructor() {
    this.color = new T(), this.color.value = "", this.image = "", this.position = "", this.repeat = "", this.size = "", this.opacity = 1;
  }
  load(e) {
    !e || (e.color !== void 0 && (this.color = T.create(this.color, e.color)), e.image !== void 0 && (this.image = e.image), e.position !== void 0 && (this.position = e.position), e.repeat !== void 0 && (this.repeat = e.repeat), e.size !== void 0 && (this.size = e.size), e.opacity !== void 0 && (this.opacity = e.opacity));
  }
}
class Ot {
  constructor() {
    this.color = new T(), this.color.value = "#fff", this.opacity = 1;
  }
  load(e) {
    !e || (e.color !== void 0 && (this.color = T.create(this.color, e.color)), e.opacity !== void 0 && (this.opacity = e.opacity));
  }
}
class St {
  constructor() {
    this.composite = "destination-out", this.cover = new Ot(), this.enable = !1;
  }
  load(e) {
    if (!!e) {
...
class we {
  ...
  get ids() {
    return B(this.selectors, (e) => e.replace("#", ""));
  }
  set ids(e) {
    this.selectors = B(e, (t) => `#${t}`);
  }
  load(e) {
    var t, i;
    if (!e)
...
class Dt {
  constructor() {
    this.onClick = new It(), this.onDiv = new we(), this.onHover = new Et(), this.resize = !0;
  }
  get onclick() {
    return this.onClick;
  }
...
class Re {
  constructor(e, t) {
    this.detectsOn = "window", this.events = new Dt(), this.modes = new At(e, t);
  }
  get detect_on() {
...
class Ht {
  constructor() {
    this.disable = !1, this.reduce = new Ft();
  }
  load(e) {
...
class Bt {
  constructor() {
    this.h = new re(), this.s = new re(), this.l = new re();
  }
  load(e) {
...
class U {
  constructor() {
    this.random = new $t(), this.value = 0;
  }
  load(e) {
...
class Ie {
  constructor() {
    this.horizontal = new xe(), this.vertical = new xe();
  }
  load(e) {
...
class Gt {
  constructor() {
    this.bounce = new Ie(), this.enable = !1, this.mode = "bounce", this.overlap = new Ut();
  }
  load(e) {
...
class Jt {
  constructor() {
    this.clamp = !0, this.delay = new jt(), this.enable = !1, this.options = {};
  }
  load(e) {
...
class Zt {
  constructor() {
    this.enable = !1, this.length = 10, this.fillColor = new T(), this.fillColor.value = "#000000";
  }
  load(e) {
    !e || (e.enable !== void 0 && (this.enable = e.enable), this.fillColor = T.create(this.fillColor, e.fillColor), e.length !== void 0 && (this.length = e.length));
  }
}
class Qt {
  constructor() {
...
class Kt {
  ...
  load(e) {
    !e || (e.acceleration !== void 0 && (this.acceleration = y(e.acceleration)), e.enable !== void 0 && (this.enable = e.enable), this.position = e.position ? M({}, e.position) : void 0);
  }
}
class ei {
  constructor() {
    this.angle = new Nt(), this.attract = new Xt(), this.center = {
      x: 50,
      y: 50,
      mode: "percent",
      radius: 0
    }, this.decay = 0, this.distance = {}, this.direction = "none", this.drift = 0, this.enable = !1, this.gravity = new Yt(), this.path = new Jt(), this.outModes = new Qt(), this.random = !1, this.size = !1, this.speed = 2, this.spin = new Kt(), this.straight = !1, this.trail = new Zt(), this.vibrate = !1, this.warp = !1;
  }
  get bounce() {
  ...
  load(e) {
    ...
    this.angle.load(typeof e.angle == "number" ? { value: e.angle } : e.angle), this.attract.load(e.attract), this.center = M((t = this.center) !== null && t !== void 0 ? t : {}, e.center), e.decay !== void 0 && (this.decay = e.decay), e.direction !== void 0 && (this.direction = e.direction), e.distance !== void 0 && (this.distance = typeof e.distance == "number" ? {
      ...
      vertical: e.distance
    } : Object.assign({}, e.distance)), e.drift !== void 0 && (this.drift = y(e.drift)), e.enable !== void 0 && (this.enable = e.enable), this.gravity.load(e.gravity);
    ...
    r !== void 0 && (typeof r == "object" ? this.outModes.load(r) : this.outModes.load({
      default: r
    })), this.path.load((o = e.path) !== null && o !== void 0 ? o : e.noise), e.random !== void 0 && (this.random = e.random), e.size !== void 0 && (this.size = e.size), e.speed !== void 0 && (this.speed = y(e.speed)), this.spin.load(e.spin), e.straight !== void 0 && (this.straight = e.straight), this.trail.load(e.trail), e.vibrate !== void 0 && (this.vibrate = e.vibrate), e.warp !== void 0 && (this.warp = e.warp);
  }
}
class Te {
  constructor() {
...
class ii extends U {
  constructor() {
    super(), this.animation = new ti(), this.random.minimumValue = 0.1, this.value = 1;
  }
  get anim() {
...
class ni {
  constructor() {
    this.density = new si(), this.limit = 0, this.value = 100;
  }
  get max() {
    return this.limit;
  }
...
class ri extends U {
  constructor() {
    super(), this.animation = new oi(), this.direction = "clockwise", this.path = !1, this.value = 0;
  }
  load(e) {
...
class ai {
  constructor() {
    this.blur = 0, this.color = new T(), this.enable = !1, this.offset = {
      x: 0,
      y: 0
    }, this.color.value = "#000";
  }
  load(e) {
    !e || (e.blur !== void 0 && (this.blur = e.blur), this.color = T.create(this.color, e.color), e.enable !== void 0 && (this.enable = e.enable), e.offset !== void 0 && (e.offset.x !== void 0 && (this.offset.x = e.offset.x), e.offset.y !== void 0 && (this.offset.y = e.offset.y)));
  }
}
class Ee {
  constructor() {
...
class hi extends U {
  constructor() {
    super(), this.animation = new li(), this.random.minimumValue = 1, this.value = 3;
  }
  get anim() {
    return this.animation;
  }
...
class ze {
  ...
  load(e) {
    !e || (e.color !== void 0 && (this.color = J.create(this.color, e.color)), e.width !== void 0 && (this.width = e.width), e.opacity !== void 0 && (this.opacity = e.opacity));
  }
}
class ci extends U {
  constructor() {
...
class ui {
  constructor(e, t) {
    this._engine = e, this._container = t, this.bounce = new Ie(), this.collisions = new Gt(), this.color = new J(), this.color.value = "#fff", this.groups = {}, this.move = new ei(), this.number = new ni(), this.opacity = new ii(), this.reduceDuplicates = !1, this.rotate = new ri(), this.shadow = new ai(), this.shape = new Ee(), this.size = new hi(), this.stroke = new ze(), this.zIndex = new ci();
  }
  load(e) {
    var t, i, s, o, r, a;
    if (!e)
      return;
    if (this.bounce.load(e.bounce), this.color.load(J.create(this.color, e.color)), e.groups !== void 0)
...
class di {
  constructor(e, t) {
    this._engine = e, this._container = t, this.autoPlay = !0, this.background = new Ct(), this.backgroundMask = new St(), this.fullScreen = new Rt(), this.detectRetina = !0, this.duration = 0, this.fpsLimit = 120, this.interactivity = new Re(e, t), this.manualParticles = [], this.motion = new Ht(), this.particles = Ae(this._engine, this._container), this.pauseOnBlur = !0, this.pauseOnOutsideViewport = !0, this.responsive = [], this.smooth = !1, this.style = {}, this.themes = [], this.zLayers = 100;
  }
  get backgroundMode() {
  ...
  load(e) {
    ...
    if (!e)
      return;
    e.preset !== void 0 && B(e.preset, (u) => this._importPreset(u)), e.autoPlay !== void 0 && (this.autoPlay = e.autoPlay);
  ...
  setTheme(e) {
    if (e) {
      ...
      const t = typeof matchMedia < "u" && matchMedia("(prefers-color-scheme: dark)"), i = t && t.matches, s = this._findDefaultTheme(i ? "dark" : "light");
...
const Me = (n) => {
  !(pe(n.outMode, n.checkModes) || pe(n.outMode, n.checkModes)) || (n.coord > n.maxCoord - n.radius * 2 ? n.setCb(-n.radius) : n.coord < n.radius * 2 && n.setCb(n.radius));
};
class pi {
  constructor(e, t, i, s, o, r) {
    var a, l, c, d, u, h, p, f, m, v, g, k, S;
    this.id = t, this.container = i, this.group = r, this._engine = e, this.fill = !0, this.close = !0, this.lastPathTime = 0, this.destroyed = !1, this.unbreakable = !1, this.rotation = 0, this.misplaced = !1, this.retina = {
      maxDistance: {}
    }, this.outType = "normal", this.ignoresResizeRatio = !0;
    const P = i.retina.pixelRatio, w = i.actualOptions, x = Ae(this._engine, i, w.particles), E = x.shape.type, L = x.reduceDuplicates;
    if (this.shape = X(E, this.id, L), o != null && o.shape) {
      if (o.shape.type) {
        const Ve = o.shape.type;
        this.shape = X(Ve, this.id, L);
      }
      const R = new Ee();
      R.load(o.shape), this.shape && (this.shapeData = this._loadShapeData(R, L));
    } else
      this.shapeData = this._loadShapeData(x.shape, L);
    x.load(o), x.load((a = this.shapeData) === null || a === void 0 ? void 0 : a.particles), this.interactivity = new Re(e, i), this.interactivity.load(i.actualOptions.interactivity), this.interactivity.load(x.interactivity), this.fill = (c = (l = this.shapeData) === null || l === void 0 ? void 0 : l.fill) !== null && c !== void 0 ? c : this.fill, this.close = (u = (d = this.shapeData) === null || d === void 0 ? void 0 : d.close) !== null && u !== void 0 ? u : this.close, this.options = x;
    const A = this.options.move.path;
    this.pathDelay = Ne(A.delay) * 1e3, A.generator && (this.pathGenerator = this._engine.plugins.getPathGenerator(A.generator), this.pathGenerator && i.addPath(A.generator, this.pathGenerator) && this.pathGenerator.init(i));
    const He = b(this.options.zIndex.value);
    i.retina.initParticle(this);
    const $ = this.options.size, ce = $.value, Z = $.animation;
    if (this.size = {
      enable: $.animation.enable,
      value: b($.value) * i.retina.pixelRatio,
      max: te(ce) * P,
      min: ee(ce) * P,
      loops: 0,
      maxLoops: b($.animation.count)
    }, Z.enable) {
      switch (this.size.status = 0, this.size.decay = 1 - b(Z.decay), Z.startValue) {
        case "min":
          this.size.value = this.size.min, this.size.status = 0;
          break;
        case "random":
          this.size.value = W(this.size) * P, this.size.status = I() >= 0.5 ? 0 : 1;
          break;
        case "max":
        default:
      ...
      this.size.velocity = ((h = this.retina.sizeAnimationSpeed) !== null && h !== void 0 ? h : i.retina.sizeAnimationSpeed) / 100 * i.retina.reduceFactor, Z.sync || (this.size.velocity *= I());
    }
    this.bubble = {
      inRange: !1
    }, this.slow = {
      inRange: !1,
      factor: 1
    }, this.position = this._calcPosition(i, s, ke(He, 0, i.zLayers)), this.initialPosition = this.position.copy();
    const ue = i.canvas.size, se = this.options.move.center, de = se.mode === "percent";
    switch (this.moveCenter = {
      x: ((p = se.x) !== null && p !== void 0 ? p : 50) * (de ? ue.width / 100 : 1),
      y: ((f = se.y) !== null && f !== void 0 ? f : 50) * (de ? ue.height / 100 : 1),
      radius: (m = this.options.move.center.radius) !== null && m !== void 0 ? m : 0,
      mode: (v = this.options.move.center.mode) !== null && v !== void 0 ? v : "percent"
    }, this.direction = Ye(this.options.move.direction, this.position, this.moveCenter), this.options.move.direction) {
      case "inside":
        this.outType = "inside";
        break;
      case "outside":
    ...
    this.initialVelocity = this._calculateVelocity(), this.velocity = this.initialVelocity.copy(), this.moveDecay = 1 - b(this.options.move.decay), this.offset = V.origin;
    const Q = i.particles;
    Q.needsSort = Q.needsSort || Q.lastZIndex < this.position.z, Q.lastZIndex = this.position.z, this.zIndexFactor = this.position.z / i.zLayers, this.sides = 24;
    ...
    const fe = z == null ? void 0 : z.getSidesCount;
    fe && (this.sides = fe(this)), this.spawning = !1, this.shadowColor = q(this.options.shadow.color);
  ...
  getFillColor() {
    var e, t;
    const i = (e = this.bubble.color) !== null && e !== void 0 ? e : ge(this.color);
    if (i && this.roll && (this.backColor || this.roll.alter)) {
      ...
      if (Math.floor((((t = this.roll.angle) !== null && t !== void 0 ? t : 0) + o) / (Math.PI / s)) % 2) {
        ...
        if (this.roll.alter)
          return ft(i, this.roll.alter.type, this.roll.alter.value);
      }
    }
    return i;
  }
  ...
  getStrokeColor() {
    var e, t;
    return (t = (e = this.bubble.color) !== null && e !== void 0 ? e : ge(this.strokeColor)) !== null && t !== void 0 ? t : this.getFillColor();
  }
  isInsideCanvas() {
  ...
  _calculateVelocity() {
    const t = je(this.direction).copy(), i = this.options.move;
    ...
    return i.straight || (t.angle += W(y(r.left, r.right))), i.random && typeof i.speed == "number" && (t.length *= I()), t;
  }
  _checkOverlap(e, t = 0) {
    ...
    for (const l of this.container.particles.array)
      if (le(e, l.position) < s + l.getRadius()) {
        a = !0;
        break;
      }
    return a;
...
class D extends Le {
  ...
  intersects(e) {
    e instanceof Fe && e.intersects(this);
    const t = this.size.width, i = this.size.height, s = this.position, o = e.position, r = e instanceof D ? e.size : { width: 0, height: 0 }, a = r.width, l = r.height;
...
class F {
  ...
  query(e, t, i) {
    ...
    for (const c of this.points)
      !e.contains(c.position) && le(e.position, c.position) > c.particle.getRadius() && (!t || t(c.particle)) || l.push(c.particle);
  ...
  queryCircle(e, t, i) {
    return this.query(new Fe(e.x, e.y, t), i);
  }
  queryRectangle(e, t, i) {
    return this.query(new D(e.x, e.y, t.width, t.height), i);
  }
  subdivide() {
    ...
    this.northEast = new F(new D(e, t, i / 2, s / 2), o), this.northWest = new F(new D(e + i / 2, t, i / 2, s / 2), o), this.southEast = new F(new D(e, t + s / 2, i / 2, s / 2), o), this.southWest = new F(new D(e + i / 2, t + s / 2, i / 2, s / 2), o), this.divided = !0;
  }
}
class mi {
  constructor(e, t) {
    this.container = t, this._engine = e, this.nextId = 0, this.array = [], this.zArray = [], this.limit = 0, this.needsSort = !1, this.lastZIndex = 0, this.freqs = {
      links: /* @__PURE__ */ new Map(),
      triangles: /* @__PURE__ */ new Map()
    }, this.interactionManager = new fi(this._engine, t);
    const i = this.container.canvas.size;
    this.quadTree = new F(new D(-i.width / 4, -i.height / 4, i.width * 3 / 2, i.height * 3 / 2), 4), this.movers = this._engine.plugins.getMovers(t, !0), this.updaters = this._engine.plugins.getUpdaters(t, !0);
  }
  get count() {
  ...
  async draw(e) {
    ...
    this.quadTree = new F(new D(-i.width / 4, -i.height / 4, i.width * 3 / 2, i.height * 3 / 2), 4), t.canvas.clear(), await this.update(e), this.needsSort && (this.zArray.sort((s, o) => o.position.z - s.position.z || s.id - o.id), this.lastZIndex = this.zArray[this.zArray.length - 1].position.z, this.needsSort = !1);
  ...
  getLinkFrequency(e, t) {
    const i = y(e.id, t.id), s = `${ee(i)}_${te(i)}`;
    let o = this.freqs.links.get(s);
    return o === void 0 && (o = I(), this.freqs.links.set(s, o)), o;
  }
  getTriangleFrequency(e, t, i) {
    ...
    return l === void 0 && (l = I(), this.freqs.triangles.set(a, l)), l;
  }
  handleClickMode(e) {
  ...
  async update(e) {
    ...
    for (const r of this.array) {
      ...
      this.quadTree.insert(new vi(r.getPosition(), r));
    }
    for (const r of o)
      this.remove(r);
  ...
  _pushParticle(e, t, i, s) {
    try {
      const o = new pi(this._engine, this.nextId, this.container, e, t, i);
      let r = !0;
...
class gi {
  ...
  init() {
    const e = this.container, t = e.actualOptions;
    this.pixelRatio = !t.detectRetina || j() ? 1 : window.devicePixelRatio;
    const i = this.container.actualOptions.motion;
    if (i && (i.disable || i.reduce.value))
      if (j() || typeof matchMedia > "u" || !matchMedia)
        this.reduceFactor = 1;
      else {
...
class bi {
  constructor(e, t, i) {
    this.id = t, this._engine = e, this.fpsLimit = 120, this.smooth = !1, this.duration = 0, this.lifeTime = 0, this._firstStart = !0, this.started = !1, this.destroyed = !1, this._paused = !0, this.lastFrameTime = 0, this.zLayers = 100, this.pageHidden = !1, this._sourceOptions = i, this._initialSourceOptions = i, this.retina = new gi(this), this.canvas = new zt(this), this.particles = new mi(this._engine, this), this.frameManager = new kt(this), this.pathGenerators = /* @__PURE__ */ new Map(), this.interactivity = {
      mouse: {
        clicking: !1,
        inside: !1
      }
    }, this.plugins = /* @__PURE__ */ new Map(), this.drawers = /* @__PURE__ */ new Map(), this._options = G(this._engine, this), this.actualOptions = G(this._engine, this), this._eventListeners = new Mt(this), typeof IntersectionObserver < "u" && IntersectionObserver && (this._intersectionObserver = new IntersectionObserver((s) => this._intersectionManager(s))), this._engine.dispatchEvent("containerBuilt", { container: this });
  }
  get options() {
  ...
  addPath(e, t, i = !1) {
    return !_(this) || !i && this.pathGenerators.has(e) ? !1 : (this.pathGenerators.set(e, t != null ? t : Pe), !0);
  }
  destroy() {
    if (!_(this))
      return;
  ...
  draw(e) {
    if (!_(this))
      return;
    let t = e;
    this._drawAnimationFrame = Qe()(async (i) => {
  ...
  async init() {
    ...
    this._options = G(this._engine, this, this._initialSourceOptions, this.sourceOptions), this.actualOptions = G(this._engine, this, this._options), this.retina.init(), this.canvas.init(), this.updateActualOptions(), this.canvas.initBackground(), this.canvas.resize(), this.zLayers = this.actualOptions.zLayers, this.duration = b(this.actualOptions.duration) * 1e3, this.lifeTime = 0, this.fpsLimit = this.actualOptions.fpsLimit > 0 ? this.actualOptions.fpsLimit : 120, this.smooth = this.actualOptions.smooth;
  ...
  pause() {
    if (!!_(this) && (this._drawAnimationFrame !== void 0 && (Ke()(this._drawAnimationFrame), delete this._drawAnimationFrame), !this._paused)) {
...
class xi {
  ...
  async loadOptions(e) {
    var t, i, s;
    const o = (t = e.tagId) !== null && t !== void 0 ? t : `tsparticles${Math.floor(I() * 1e4)}`, { index: r, url: a, remote: l } = e, c = l ? await wi(a, r) : e.options;
    ...
    const u = X(c, r), h = this._engine.dom(), p = h.findIndex((v) => v.id === o);
    if (p >= 0) {
    ...
    if (d.tagName.toLowerCase() === "canvas")
      f = d, f.dataset[Y] = "false";
    else {
      const v = d.getElementsByTagName("canvas");
      v.length ? (f = v[0], f.dataset[Y] = "false") : (f = document.createElement("canvas"), f.dataset[Y] = "true", d.appendChild(f));
    }
...
class Mi {
  constructor() {
    this._domArray = [], this._eventDispatcher = new $e(), this._initialized = !1, this._loader = new xi(this), this.plugins = new zi(this);
  }
  addEventListener(e, t) {
...
const Si = We({
  ...
  mounted() {
    qe(async () => {
      ...
      N.init(), this.particlesInit && await this.particlesInit(N);
      const n = (i) => {
        H = i, this.particlesLoaded && H && this.particlesLoaded(H);
      }, e = await (this.url ? N.loadJSON(this.id, this.url) : N.load(this.id, (t = this.options) != null ? t : {}));
      n(e);
    });
  },
  unmounted() {
...
function Ti(n, e, t, i, s, o) {
  return Be(), Ue("div", { id: n.id }, null, 8, Ii);
}
const Ei = /* @__PURE__ */ Ri(Si, [["render", Ti]]), Ai = (n, e) => {
  n.component("Particles", Ei);
};
export {
  Ei as ParticlesComponent,
  Ai as default
};
